...
The same dynamics are modality-agnostic under spectral isomorphism, enabling one substrate for text, image, and audio without modality-specific fusion objectives. We evaluate this framework on small-scale multimodal and sequence experiments, using AI as a demanding test domain rather than the endpoint itself. The central contribution is evidence that thermodynamic-wave dynamics can function as a practical information-processing system; the open question is scale.
\end{abstract}
