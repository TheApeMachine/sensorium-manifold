...
\quad 100 particles & 197 ms \\
\quad 10,000 particles & 186 ms \\
\midrule
\multicolumn{2}{l}{\textit{Latency vs Sequence Length (O(k) test)}} \\
\quad N=500 & 3.52 ms/step \\
\quad N=1,000 & 3.47 ms/step \\
\quad N=2,000 & 3.45 ms/step \\
\quad N=4,000 & 3.82 ms/step \\
\quad N=8,000 & 3.87 ms/step \\
\midrule
\multicolumn{2}{l}{\textit{Generalization}} \\
\quad Repetitive & 64 crystallized \\
\quad Semi Random & 64 crystallized \\
